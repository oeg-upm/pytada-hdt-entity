...
# Register SwigPyIterator in _parser:
_parser.SwigPyIterator_swigregister(SwigPyIterator)
...
class Parser(object):
    ...
    def parse(self) -> "std::list< std::list< std::string,std::allocator< std::string > > *,std::allocator< std::list< std::string,std::allocator< std::string > > * > > *":
        return _parser.Parser_parse(self)

    def parse_vertical(self) -> "std::list< std::list< std::string,std::allocator< std::string > > *,std::allocator< std::list< std::string,std::allocator< std::string > > * > > *":
        return _parser.Parser_parse_vertical(self)

    def set_delimiter(self, arg2: "char") -> "void":
        return _parser.Parser_set_delimiter(self, arg2)

    def set_escape_chars(self, arg2: "std::string") -> "void":
        return _parser.Parser_set_escape_chars(self, arg2)

    def get_printable(self, arg2: "std::string") -> "std::string":
        return _parser.Parser_get_printable(self, arg2)
    __swig_destroy__ = _parser.delete_Parser

# Register Parser in _parser:
_parser.Parser_swigregister(Parser)
